...
label escapeplan:
    ...
    t "Tell me about it!"
    t "Anyway, don't let her get too comfortable here; I'm sure Krag would love to see her out on stage for another game."
    ...
    "After confirming that he was unconscious, everyone turned to me."
    play music vast_places
    ...
    l "After seeing him use it on the guard who shot that kid, I knew I had to use it to get you all out."
    ...
    l "Mr. Sprinkles isn't planning on letting any of the parents leave alive!"
    ...
    $l_exp = "determined"
    l "The same way we just took out this guard, but on a larger scale."
    woman "You expect us to just go out there and start tackling and fighting the guards?? There are so many of them!"
    $l_exp = "mad"
    l "And the number of us in this room alone can at least match their numbers."
    l "If we get the parents already in the audience to help us, then we'll easily outnumber the REDD!"
    ...
    man "They could easily pin us down and snap our fucking necks or something!"
    $l_exp = "concerned"
    l "They could. They're still highly-trained killers on top of being biological sociopaths."
    $l_exp = "mad"
    l "But if we sit here and do nothing, it's guaranteed death. At least fighting back will give us a chance."
    l "A chance to survive the REDD War! A chance to see our children again!"
