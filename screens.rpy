...
screen navigation():
    ...
    if renpy.get_screen('main_menu'):
        hbox:
            ...
            spacing 25
            imagebutton auto "gui/start_%s.png":
                hover_sound "audio/se/button_start.ogg"
                action Start()
            imagebutton auto "gui/load_%s.png":
                hover_sound "audio/se/button_load.ogg"
                action ShowMenu("load")
            imagebutton auto "gui/options_%s.png":
                hover_sound "audio/se/button_options.ogg"
